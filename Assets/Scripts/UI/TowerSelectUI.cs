...
namespace Underdark
{
    ...
    {
        [Header("References")]
        public Transform       cardContainer;   // 하단 카드 스크롤 영역
        public Transform       slotContainer;   // 상단 슬롯 4개 부모 (빈 패널)
        ...
        private GameObject[]     _slots;          // 상단 슬롯 UI
        ...
        private void Start()
        {
            ...
            // 기본 소유 초기화 (isDefault=true 터렛들을 첫 실행 시 소유 상태로)
        ...
        /// <summary>슬롯 클릭 시 해당 슬롯의 터렛 선택 해제</summary>
        ...
        /// <summary>Registry entries에서 isWall=false인 것만 풀에 추가 (소유 먼저, 미소유 뒤)</summary>
        ...
        private GameObject CreateCard(TurretType type)
        {
            ...
            btn.interactable = isOwned;  // 미소유 카드는 버튼 비활성
